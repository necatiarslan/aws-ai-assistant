...
class S3Explorer {
    constructor(panel, extensionUri, bucket, key) {
        this._disposables = [];
    ...
    SetS3ExplorerItem(bucket, key) {
        this.S3ExplorerItem = new S3ExplorerItem_1.S3ExplorerItem(bucket, key || "");
    }
    async RenderHtml() {
    ...
    static Render(extensionUri, bucket, key, changeKey = undefined) {
